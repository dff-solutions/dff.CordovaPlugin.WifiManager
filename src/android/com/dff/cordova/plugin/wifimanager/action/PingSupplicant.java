...
public class PingSupplicant extends WifiManagerAction {
	public static final String ACTION_NAME = "pingSupplicant";

	public PingSupplicant(String action, JSONArray args, CallbackContext callbackContext, CordovaInterface cordova,
